<?php 
    ...
    $list_news_relative = $action_news->getListNewsRelate_byIdCat_hasLimit($row['newscat_id'], 3);
?>
            ...
            <div class="item">
                <div class="gb-tintuc-item">
                    ...
                    <div class="item-text">
                        ...
                        <time> <i class="fa fa-calendar-plus-o" aria-hidden="true"></i> <?= substr($item['news_update_date'], 0, 10) ?></time>
