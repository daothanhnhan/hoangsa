...
jQuery(document).ready(function ($) {
	...
	_CaptionTransitions["L|IB"] = { $Duration: 1200, x: 0.1, $Easing: { $Left: $JssorEasing$.$EaseInOutBack }, $Opacity: 2 };	
	_CaptionTransitions["R|IB"] = { $Duration: 1200, x: -0.6, $Easing: { $Left: $JssorEasing$.$EaseInOutBack }, $Opacity: 2 };
	_CaptionTransitions["T|IB"] = { $Duration: 1200, y: 0.6, $Easing: { $Top: $JssorEasing$.$EaseInOutBack }, $Opacity: 2 };
	
	/*IMG main SlideBeagbone*/	
	_CaptionTransitions["Limg"] = { $Duration: 2000, x: -0.1, $Easing: { $Left: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };
	_CaptionTransitions["Rimg"] = { $Duration: 1000, x: 0.1, $Easing: { $Left: $JssorEasing$.$EaseInOutSine }, $Opacity: 2 };
	_CaptionTransitions["L|IBimg"] = { $Duration: 1500, x: 0.1, $Easing: { $Left: $JssorEasing$.$EaseInOutBack }, $Opacity: 2 };
	_CaptionTransitions["R|IBimg"] = { $Duration: 1000, x: -0.1, $Easing: { $Right: $JssorEasing$.$EaseInOutBack }, $Opacity: 2 };
	/* x>0 bên trái, x<0 bên phai */

/*
Clip 1: quét từ trái sang
	 2: quét từ phải sang
	 3: trung tâm ra
	 5: sổ từ góc trên trái
	 6: sổ từ góc trên phải
	 7: sổ từ trung tâm trên xuống
	 8: hiện từ dưới lên
	 9: sổ từ góc dưới trái
	 10: sổ từ góc dưới phải
	 12:quét từ trung tâm ra
*/
	   


	_CaptionTransitions["CLIP|LR"] = { $Duration: 500, $Clip: 12, $Easing: { $Clip: $JssorEasing$.$EaseInOutCubic }, $Opacity: 2 };
	_CaptionTransitions["CLIP|TB"] = { $Duration: 900, $Clip: 12, $Easing: { $Clip: $JssorEasing$.$EaseInOutCubic }, $Opacity: 2 };
	_CaptionTransitions["CLIP|L"] = { $Duration: 900, $Clip: 1, $Easing: { $Clip: $JssorEasing$.$EaseInOutCubic }, $Opacity: 2 };

	_CaptionTransitions["MCLIP|R"] = { $Duration: 700, $Clip: 2, $Move: true, $Easing: { $Clip: $JssorEasing$.$EaseInOutCubic }, $Opacity: 2 };
