...
<div id="divWrapper">
    <div class="coverFormLogin">
        ...
        <p class="endLogin">Công ty TNHH Phát Triển Thương Hiệu Cafelink Việt Nam<br /><em style="text-decoration:underline;">Điện thoại:</em> <strong>0865.689.886</strong> - <em style="text-decoration:underline;">Email:</em> <strong>kinhdoanh@cafelink.org</strong><br /><em style="text-decoration:underline;">Website:</em> cafelink.org</p>
