        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    ///////////// cho dem /////////////////
                    case "cho-dem":
                        include_once("template/cho-dem/cho-dem.php");
                        break;
                    case "them-cho-dem":
                        include_once("template/cho-dem/them-cho-dem.php");
                        break;
                    case "sua-cho-dem":
                        include_once("template/cho-dem/sua-cho-dem.php");
                        break;
                    case "xoa-cho-dem":
                        include_once("template/cho-dem/xoa-cho-dem.php");
                        break;
                    ///////////// he thống ////////////////
                    case "he-thong":
                        include_once("template/he-thong/he-thong.php");
                        break;
                    case "them-he-thong":
                        include_once("template/he-thong/them-he-thong.php");
                        break;
                    case "sua-he-thong":
                        include_once("template/he-thong/sua-he-thong.php");
                        break;
                    case "xoa-he-thong":
                        include_once("template/he-thong/xoa-he-thong.php");
                        break;
                    /////////////// video ////////////////
                    case "video":
                    ...
                    ///////////// bản đồ  /////////////////
                    case "ban-do":
                        include_once("template/ban-do/ban-do.php");
                        break;
                    case "them-ban-do":
                        include_once("template/ban-do/them-ban-do.php");
                        break;
                    case "sua-ban-do":
                        include_once("template/ban-do/sua-ban-do.php");
                        break;
                    case "xoa-ban-do":
                        include_once("template/ban-do/xoa-ban-do.php");
                        break;
                    ///////////// Default /////////////////
                    default:
