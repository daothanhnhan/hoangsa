           ...
           <li><a href="index.php?page=bai-viet" title=""
            ...
            <li><a href="index.php?page=dich-vu" title=""
                   class="linkMenu <?php if ($_GET["page"] == 'dich-vu' || $_GET["page"] == 'them-dich-vu' || $_GET["page"] == 'sua-dich-vu') {
                       echo 'sltMenu';
                   } ?>"><img src="image/news2.png" class="iconMenu2"/><img src="image/news.png" class="iconMenu"/>Danh sách thư viện ảnh</a></li>
            ...
            <li><a href="index.php?page=cho-dem" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Chợ đêm hoàng sa</a>
            </li>

            <li><a href="index.php?page=he-thong" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Hệ thống coffee CCCP</a>
            </li>
