<?php 
	...
	function ban_do () {
		...
		if (isset($_POST['add_map'])) {
			...
			$sql = "INSERT INTO map (name, content) VALUES ('$name', '$content')";
			$result = mysqli_query($conn_vn, $sql);
			if ($result) {
				echo '<script type="text/javascript">alert(\'Bạn đã thêm được một bản đồ.\');window.location.href="index.php?page=ban-do"</script>';
			} else {
...
<form action="" method="post" enctype="multipart/form-data">
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <textarea name="content" class="txtNCP1" rows="6" required=""></textarea>
